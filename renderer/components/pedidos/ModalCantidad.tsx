...
const ModalCantidad = ({
  ...
  const handleAddProduct = () => {
    ...
    if ((cantidad || 1) > producto.cantidad - producto.cantidadApartada) {
      console.log(producto.cantidad - producto.cantidadApartada)
      console.log(cantidad)
      toast.error('No hay suficientes productos en stock')
      return
    }
